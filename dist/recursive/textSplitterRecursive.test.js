...
const printResultToFile = (fileName, docs, version = "v1") => {
    let file = "";
    ...
    fs.writeFileSync(`./src/recursive/test/results/${fileName.split(".")[0]}-${version}.txt`, file);
};
//# sourceMappingURL=textSplitterRecursive.test.js.map